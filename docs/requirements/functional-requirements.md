...
| FR-023 | BR-010 | The system SHALL import financial data from institution CSV and OFX/QFX exports, auto-detect formats, and map to tax-relevant structures (interest, dividends, capital gains). | CSV/OFX imports produce correct interest totals, dividend breakdowns, and capital gain/loss records matching source data. | Approved |
